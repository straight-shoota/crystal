...
man:crystal-init[1]:: Create a a new Crystal project

man:crystal-build[1]:: Compile a Crystal program

man:crystal-docs[1]:: Generate API docs for Crystal code

man:crystal-env[1]:: Print environment variables for the Crystal compiler

man:crystal-eval[1]:: Evaluate a crystal program

man:crystal-play[1]:: Run the Crystal playground

man:crystal-run[1]:: Compile and run a Crystal program

man:crystal-spec[1]:: Compile and run Crystal spec files
...
man:crystal-tool-dependencies[1]:: Show tree of required source files

*crystal-tool-expand*::  Show macro expansion for given location

*crystal-tool-flags*::   Print all macro 'flag?' values

man:crystal-tool-format[1]:: Format Crystal source files
...
man:crystal-tool-unreachable[1]:: Identify methods that are never called
