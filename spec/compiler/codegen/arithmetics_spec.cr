...
{% unless flag?(:win32) %}
  private SupportedInts            = [UInt8, UInt16, UInt32, UInt64, UInt128, Int8, Int16, Int32, Int64, Int128]
{% else %}
  private SupportedInts            = [UInt8, UInt16, UInt32, UInt64, Int8, Int16, Int32, Int64]
{% end %}

private SupportedIntsConversions = {
